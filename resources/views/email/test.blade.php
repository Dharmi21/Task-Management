                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            © 2023 demo-login. All rights reserved.</p>
...
{{-- <h2>This is password reset link!!!!</h2>
<a class="btn btn-primary" href="{{ route('reset_password', $token) }}">Reset Password</a> --}}
{{-- <a class="btn btn-primary" href="/forget_password">Reset Password</a> --}}
